...
import de.pottgames.com.jcraft.jogg.Buffer;
...
public class Info {
    ...
    int unpack_books(Buffer opb) {
        ...
        for (int i = 0; i < this.floors; i++) {
            ...
            if (this.floor_type[i] < 0 || this.floor_type[i] >= Info.VI_FLOORB) {
                this.clear();
                return -1;
            }
        ...
        for (int i = 0; i < this.residues; i++) {
            ...
            if (this.residue_type[i] < 0 || this.residue_type[i] >= Info.VI_RESB) {
                this.clear();
                return -1;
            }
        ...
        for (int i = 0; i < this.modes; i++) {
            ...
            if (this.mode_param[i].windowtype >= Info.VI_WINDOWB || this.mode_param[i].transformtype >= Info.VI_WINDOWB
    ...
    public String toString() {
        return "version:" + this.version + ", channels:" + this.channels + ", rate:" + this.rate + ", bitrate:" + this.bitrate_upper + ","
